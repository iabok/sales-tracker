...
BUCKET = "sales_app-backups"
S3_DIRECTORY = socket.gethostname()
DB_BACKUP_FILE = "sales_app_postgres_1.sql"
...
os.system("docker exec -u postgres sales_app_postgres_1 pg_dumpall > {path}".format(path=DB_BACKUP_PATH))
